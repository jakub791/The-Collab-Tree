addLayer("s", {
        ...
        requires() {if(inChallenge("s", 11) || inChallenge("s", 12) || inChallenge("s", 21)) return "Infinity"
    ...
    buyables: {
        ...
        41: {
            ...
            cost(x=player[this.layer].buyables[this.id]) { 
                let cost = new Decimal(10).sub(player[this.layer].buyables[21]).mul(new Decimal(2).pow(x))
                return cost
            },
            buy() {
        ...
        51: {
            ...
            currencyInternalName: "points",
            cost(x=player[this.layer].buyables[this.id]) { 
                let cost = new Decimal(10).sub(player[this.layer].buyables[21]).mul(new Decimal(3).pow(x))
                return cost
            },
            buy() {
        ...
        61: {
            ...
            currencyInternalName: "points",
            cost(x=player[this.layer].buyables[this.id]) { 
                let cost = new Decimal(10).sub(player[this.layer].buyables[21]).mul(new Decimal(5).pow(x))
                return cost
            },
            buy() {
        ...
        71: {
            ...
            currencyInternalName: "points",
            cost(x=player[this.layer].buyables[this.id]) { 
                let cost = new Decimal(10).sub(player[this.layer].buyables[21]).mul(new Decimal(7).pow(x))
                return cost
            },
            effect() {
