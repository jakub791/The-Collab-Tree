addLayer("cheese", {
    ...
    upgrades:{
        ...
        b2:{
            ...
            onPurchase(){player.cheese.upgrades.push('b2')},
            unlocked(){return hasUpgrade("cheese", "c1")},
            branches: [["c1", "#006080"]],
            style(){
                return {
                    'border': '5px solid',
    ...
    update(diff){
        ...
        if(player.cheese.cycle.gte(60)){
            ...
            player.cheese.currentState = Math.ceil(Math.random()*60)==21?7:
                                      player.cheese.activity.gte(30)&&player.cheese.currentState==1&&player.cheese.bruh2.gte(10)?8:
    ...
    buyables:{
            ...
            cost(){
                return player.cheese.buyables[11]
                       ...
                       .pow(player.cheese.buyables[11].gte(100)?player.cheese.buyables[11]
                                                                ...
                                                                .mul(0.015)
                                                                .add(1):1)
                       .pow(player.cheese.buyables[11].gte(255)?player.cheese.buyables[11]
                                                                .sub(255)
                                                                .mul(0.15)
                                                                .add(1):1)
            },
        ...
        12:{
            ...
            cost(){
                return new Decimal(400)
                           ...
                           .pow(player.cheese.buyables[12].gte(100)?player.cheese.buyables[12]
                                                                    ...
                                                                    .mul(0.03)
                                                                    .add(1):1)
                           .pow(player.cheese.buyables[12].gte(255)?player.cheese.buyables[12]
                                                                    .sub(255)
                                                                    .mul(0.3)
                                                                    .add(1):1)
            },
            ...
            effect(){
                return Decimal.pow(new Decimal(1.15).add(tmp.cheese.buyables[15].effect), player.cheese.buyables[12]).mul(hasUpgrade("cheese", "c2")?tmp.cheese.buyables[22].effect:1)
            },
            buy(){
                player.cheese.points = player.cheese.points
                                       .sub(this.cost())
        ...
        13:{
            ...
            cost(){return new Decimal(8000)
                              ...
                              .pow(player.cheese.buyables[13].gte(100)?player.cheese.buyables[13]
                                                                       ...
                                                                       .mul(0.045)
                                                                       .add(1):1)
                              .pow(player.cheese.buyables[13].gte(255)?player.cheese.buyables[13]
                                                                       .sub(255)
                                                                       .mul(0.45)
                                                                       .add(1):1)
            },
        ...
        14:{
            ...
            cost(){return new Decimal("1.6e12")
                              .mul(Decimal.pow(1612, player.cheese.buyables[14].pow(1.6)))
                              .pow(player.cheese.buyables[14].gte(100)?player.cheese.buyables[14]
                                                                       .sub(100)
                                                                       .mul(0.06)
                                                                       .add(1):1)
                              .pow(player.cheese.buyables[14].gte(255)?player.cheese.buyables[14]
                                                                       .sub(255)
                                                                       .mul(0.6)
                                                                       .add(1):1)
            },
            ...
            buy(){
                player.cheese.points = player.cheese.points
                                       .sub(this.cost())
                player.cheese.buyables[14] = player.cheese.buyables[14]
                                             .add(1)
                player.cheese.activity = player.cheese.activity
                                         .add(1)
            },
        ...
        15:{
            ...
            cost(){return new Decimal("3.2e13")
                              .mul(Decimal.pow(3213, player.cheese.buyables[15].pow(1.75)))
                              .pow(player.cheese.buyables[15].gte(100)?player.cheese.buyables[15]
                                                                       .sub(100)
                                                                       .mul(0.075)
                                                                       .add(1):1)
                              .pow(player.cheese.buyables[15].gte(255)?player.cheese.buyables[15]
                                                                       .sub(255)
                                                                       .mul(0.75)
                                                                       .add(1):1)
            },
            ...
            buy(){
                player.cheese.points = player.cheese.points
                                       .sub(this.cost())
                player.cheese.buyables[15] = player.cheese.buyables[15]
                                             .add(1)
                player.cheese.activity = player.cheese.activity
                                         .add(1)
            },
            display(){
                return `<h3 style='font-family: Bahnschrift SemiBold;'>Increases Cheddar Generalizer's base by +${format(this.effect())}<br>Amount: ${formatWhole(player.cheese.buyables[this.id])}<br>Cost: ${format(this.cost())} 🧀`
            },
            style(){
                return {
                    'height': '112px',
        ...
        "La Creatura":{
            content: [
                ["display-text", () => `
                    ...
                    <h2 style='font-family: Bahnschrift SemiBold;'> blessings`:``)+(tmp.cheese.cheeseGain.gt(0)?
                ...
                ["display-text", () => `
                    ...
                    <h4>${tmp.cheese.state[player.cheese.currentState][1]}<br>Next cycle in ${formatWhole(new Decimal(60).sub(player.cheese.cycle).ceil())} seconds`
                ],
                "blank",
                "blank",
                ["tree", [["ab"]]],
