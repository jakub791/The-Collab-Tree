addLayer("cheese", {
  ...
  buyables: {
    ...
    12: {
      title:
        "<h3 style='font-family: Bahnschrift SemiBold;'>Cheddar Generalizer",
      cost() {
    ...
    14: {
      title:
        "<h3 style='font-family: Bahnschrift SemiBold;'>Classy Gargantuan-or",
      cost() {
    ...
    21: {
      title:
        "<h3 style='font-family: Bahnschrift SemiBold;'>Sacrifice all of your 🧀 to Cheese Overlord",
      canAfford() {
    ...
    22: {
      title:
        "<h3 style='font-family: Bahnschrift SemiBold;'>Sacrifice all of your blessings to Cheese Overlord",
      canAfford() {
        return (
