addLayer("cheese", {
    ...
    bars: {
        feedMe: {
            ...
            height: 100,
            progress() {
                return player.cheese.hunger.div(10);
            },
            display() {
                return (
                    "<h2>Hunger Meter:<br>" +
    ...
    upgrades: {
        a0: {
            ...
            onPurchase() {
                player.cheese.upgrades.push("a0");
            },
            style() {
                return {
                    border: "5px solid",
                    "border-radius": "25%",
                    "border-color":
                        this.canAfford() && !hasUpgrade("cheese", this.id)
                            ? "rgb(255,172,51)"
                            : "",
                    color:
                        this.canAfford() && !hasUpgrade("cheese", this.id)
        ...
        b0: {
            ...
            currencyLayer: "cheese",
            onPurchase() {
                player.cheese.upgrades.push("b0");
            },
            unlocked() {
        ...
        c0: {
            ...
            currencyLayer: "cheese",
            onPurchase() {
                player.cheese.upgrades.push("c0");
            },
            unlocked() {
        ...
        c1: {
            ...
            currencyLayer: "cheese",
            onPurchase() {
                player.cheese.upgrades.push("c1");
            },
            unlocked() {
            ...
            player.cheese.currentState =
                Math.ceil(Math.random() * 60) == 21
                    ...
                    : player.cheese.activity.gte(30) &&
                      ...
                      player.cheese.bruh2.gte(player.cheese.activity.div(3))
                    ? 8
    ...
    buyables: {
        ...
        12: {
            ...
            effect() {
                return Decimal.pow(1.15, player.cheese.buyables[12]).mul(
                    hasUpgrade("cheese", "c2")
                        ? tmp.cheese.buyables[22].effect
                        : 1
                );
        ...
        22: {
            ...
            canAfford() {
                return (
                    player.cheese.blessings.gt(0) && !(tmp.cheese.state == 8)
                );
            },
            effect() {
                return player.cheese.goodBlessings.add(1).log(77).add(1).max(1);
            },
            buy() {
    ...
    tabFormat: {
        "La Creatura": {
            content: [
                ...
                [
                    ...
                    <h2 style='font-family: Bahnschrift SemiBold;'> ${
                        tmp.cheese.state[player.cheese.currentState][0]
                    }<br>
                    <span style='font-family: Bahnschrift SemiBold;'>${
        ...
        "Cheese Overlord's Heaven": {
            content: [
                ...
                [
                    "row",
                    [["upgrade", ["b0"]], "blank", "blank", ["upgrade", ["b1"]]]
                ],
                "blank",
                "blank",
                [
