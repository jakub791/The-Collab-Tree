addLayer("cheese", {
  ...
  upgrades: {
    ...
    d0: {
      ...
      tooltip: "Aaaaaaaand you just ruined a perfectly structured pyramid.<br><br>Good job.",
      effect() {
        return player.cheese.blessings.add(1).log(777).add(1);
      },
      cost() {
        ...
        return options.cheeseBuyables ?
          {
            ...
            "border-bottom-left-radius": hasUpgrade("cheese", "b1") ? "0px" : "50px",
            "border-bottom-right-radius": hasUpgrade("cheese", "b1") ? "0px" : "50px",
            "border-bottom-width": hasUpgrade("cheese", "b1") ? "2.5px" : "5px",
    ...
    15: {
      ...
      style() {
          return options.cheeseBuyables ?
          {
            ...
            width: hasUpgrade("cheese", "d0") ? "175px" : "262.5px",
            border: "5px solid",
            "border-right-width": hasUpgrade("cheese", "d0") ? "2.5px" : "5px",
            "border-bottom-width": "2.5px",
            "border-top-width": "2.5px",
            "border-left-width": "2.5px",
            "border-radius": "0px",
  ...
  tabFormat: {
    ...
    Cheese: {
      content: [
        ...
        ["blank",function () {return ["0px", options.cheeseBuyables ? "0px" : "16px"]}],
        ["row", [
            ["buyable", [14]],
            ["blank",function () {return [options.cheeseBuyables ? "0px" : "8px", "0px"]}],
            ["buyable", [15]],
            ["blank",function () {return [options.cheeseBuyables ? "0px" : "8px", "0px"]}],
            ["buyable", [16]]
        ]],
