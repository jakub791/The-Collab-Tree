(function (global, factory) {
    ...
    var Decimal =
        ...
        (function () {
            ...
            Decimal.fromMantissaExponent_noNormalize = function (
                mantissa,
                exponent
            ) {
            ...
            Decimal.affordGeometricSeries = function (
                resourcesAvailable,
                priceStart,
                priceRatio,
                currentOwned
            ...
            Decimal.sumGeometricSeries = function (
                numItems,
                priceStart,
                priceRatio,
                currentOwned
            ...
            Decimal.affordArithmeticSeries = function (
                resourcesAvailable,
                priceStart,
                priceAdd,
                currentOwned
            ...
            Decimal.sumArithmeticSeries = function (
                numItems,
                priceStart,
                priceAdd,
                currentOwned
            ...
            Decimal.efficiencyOfPurchase = function (
                cost,
                currentRpS,
                deltaRpS
            ) {
            ...
            Decimal.affordGeometricSeries_core = function (
                resourcesAvailable,
                priceStart,
                priceRatio,
                currentOwned
            ...
            Decimal.sumGeometricSeries_core = function (
                numItems,
                priceStart,
                priceRatio,
                currentOwned
            ...
            Decimal.affordArithmeticSeries_core = function (
                resourcesAvailable,
                priceStart,
                priceAdd,
                currentOwned
            ...
            Decimal.sumArithmeticSeries_core = function (
                numItems,
                priceStart,
                priceAdd,
                currentOwned
                ...
                return numItems
                    .div(2)
                    .mul(
                        actualStart.mul(2).plus(numItems.sub(1).mul(priceAdd))
                    );
            };

            Decimal.efficiencyOfPurchase_core = function (
                cost,
                currentRpS,
                deltaRpS
            ) {
      ...
      */
            ...
            Decimal.prototype.fromComponents_noNormalize = function (
                sign,
                layer,
                mag
            ) {
            ...
            Decimal.prototype.fromMantissaExponent = function (
                mantissa,
                exponent
            ) {
                this.layer = 1;
            ...
            Decimal.prototype.fromMantissaExponent_noNormalize = function (
                mantissa,
                exponent
            ) {
            ...
            Decimal.prototype.add = function (value) {
                ...
                if (layera === 0 && layerb === -1) {
                    if (
                        Math.abs(b.mag - Math.log10(a.mag)) >
                ...
                if (layera === 1 && layerb === 0) {
                    if (
                        Math.abs(a.mag - Math.log10(b.mag)) >
                        MAX_SIGNIFICANT_DIGITS
                    ) {
                        return a;
                    } else {
            ...
            Decimal.prototype.notEquals_tolerance = function (
                value,
                tolerance
            ) {
            ...
            Decimal.prototype.lt_tolerance = function (value, tolerance) {
                var decimal = D(value);
                return (
                    !this.eq_tolerance(decimal, tolerance) && this.lt(decimal)
                );
            };
            ...
            Decimal.prototype.gt_tolerance = function (value, tolerance) {
                var decimal = D(value);
                return (
                    !this.eq_tolerance(decimal, tolerance) && this.gt(decimal)
                );
            };
      ...
      */
            ...
            Decimal.prototype.factorial = function () {
                if (this.mag < 0) {
                    ...
                    return Decimal.exp(
                        Decimal.mul(this, Decimal.ln(this).sub(1))
                    );
                } else {
            ...
            Decimal.prototype.tetrate = function (
                height = 2,
                payload = FC_NN(1, 0, 1)
            ) {
            ...
            Decimal.prototype.iteratedexp = function (
                height = 2,
                payload = FC_NN(1, 0, 1)
            ) {
            ...
            Decimal.prototype.iteratedlog = function (base = 10, times = 1) {
                ...
                if (result.layer - base.layer > 3) {
                    var layerloss = Math.min(
                        times,
                        result.layer - base.layer - 3
                    );
                    times -= layerloss;
        ...
        return Decimal.dNegOne.add(top.div(bottom));
            ...
            Decimal.prototype.layeradd10 = function (diff) {
                ...
                if (diff > 0) {
                    ...
                    var diffToNextSlog = Math.log10(
                        Math.log(1e10) / Math.log(result.mag),
                        10
                    );
            ...
            Decimal.prototype.layeradd = function (diff, base) {
                ...
                if (slogdest >= 0) {
                    ...
                    return Decimal.log(
                        Decimal.tetrate(base, slogdest + 1),
                        base
                    );
                } else {
                    Decimal.log(
...
*/
            ...
            Decimal.prototype.pentate = function (
                height = 2,
                payload = FC_NN(1, 0, 1)
            ) {
                payload = D(payload);
