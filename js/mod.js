...
function getPointGen() {
	...
	let gain = new Decimal(0.01666666666666666666666666666667).mul(new Decimal(2).pow(player.s.buyables[21]));
        ...
        if (inChallenge("s", 21) && gain.gt(new Decimal(12))) gain = new Decimal(10).add(gain.log(new Decimal(2).pow(hahaSoftcapGoBrrrrrrrr)).root(8916100448256).max(1))
        if (inChallenge("s", 21) && gain.gt(new Decimal(13))) gain = new Decimal(10).add(gain.log(new Decimal(2).pow(hahaSoftcapGoBrrrrrrrr)).root(151437553296126.5).max(1))
        if (inChallenge("s", 21) && gain.gt(new Decimal(14))) gain = new Decimal(10).add(gain.log(new Decimal(2).pow(hahaSoftcapGoBrrrrrrrr)).root(2778001706389504).max(1))
        if (inChallenge("s", 21) && gain.gt(new Decimal(15))) gain = new Decimal(10).add(gain.log(new Decimal(2).pow(hahaSoftcapGoBrrrrrrrr)).root(54736736297607421.875).max(1))
        if (inChallenge("s", 21) && gain.gt(new Decimal(16))) gain = new Decimal(10).add(gain.log(new Decimal(2).pow(hahaSoftcapGoBrrrrrrrr)).root(1152921504606846976).max(1))
        if (inChallenge("s", 21) && gain.gt(new Decimal(17))) gain = new Decimal(10).add(gain.log(new Decimal(2).pow(hahaSoftcapGoBrrrrrrrr)).root(25851258183948023880.53125).max(1))
        if (inChallenge("s", 21) && gain.gt(new Decimal(18))) gain = new Decimal(10).add(gain.log(new Decimal(2).pow(hahaSoftcapGoBrrrrrrrr)).root(614787626176508399616).max(1))
        if (inChallenge("s", 21) && gain.gt(new Decimal(19))) gain = new Decimal(10).add(gain.log(new Decimal(2).pow(hahaSoftcapGoBrrrrrrrr)).root(15456403559846199915031.0859375).max(1))
        if (inChallenge("s", 21) && gain.gt(new Decimal(20))) gain = new Decimal(10).add(gain.log(new Decimal(2).pow(hahaSoftcapGoBrrrrrrrr)).root(409600000000000000000000).max(1))
        if (inChallenge("s", 21) && gain.gt(new Decimal(21))) gain = new Decimal(10).add(gain.log(new Decimal(2).pow(hahaSoftcapGoBrrrrrrrr)).root(11411302770285122112072508.634766).max(1))
        if (inChallenge("s", 21) && gain.gt(new Decimal(22))) gain = new Decimal(10).add(gain.log(new Decimal(2).pow(hahaSoftcapGoBrrrrrrrr)).root(333425661488495661520162816).max(1))
        if (inChallenge("s", 21) && gain.gt(new Decimal(23))) gain = new Decimal(10).add(gain.log(new Decimal(2).pow(hahaSoftcapGoBrrrrrrrr)).root(10195541015550738298024918413.363).max(1))
        if (inChallenge("s", 21) && gain.gt(new Decimal(24))) gain = new Decimal(10).add(gain.log(new Decimal(2).pow(hahaSoftcapGoBrrrrrrrr)).root(325619086145088897570576531456).max(1))
        if (inChallenge("s", 21) && gain.gt(new Decimal(25))) gain = new Decimal(10).add(gain.log(new Decimal(2).pow(hahaSoftcapGoBrrrrrrrr)).root(10842021724855044340074528008699).max(1))
        if (inChallenge("s", 21) && gain.gt(new Decimal(26))) gain = new Decimal(10).add(gain.log(new Decimal(2).pow(hahaSoftcapGoBrrrrrrrr)).root(375739720471628253832804827172860).max(1))
